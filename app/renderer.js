...
const getLocalWeather = (latitude, longitude) => {
  ...
  xhr.onreadystatechange =  () => {
    if (xhr.readyState === 4) {
      ...
      mainText.innerText = `It's ${Math.round(response.main.temp)} degrees in ${response.name}. Also ${response.weather[0].main.toLowerCase()}.`
